...
An interactive multi-page Dash application for exploring FDA Adverse Event Reporting System (FAERS) Q4 2025 data. Built for DATS6401 final project (MSCS, Northeastern University).
...
The UI uses the **Orbix palette** (`#0583F2`, `#295591`, `#668CD9`, `#A36378`, `#CA896D`, `#DADDE9`, `#0D0D0D`, `#F2F2F2`) with a white sidebar, `#DADDE9` page background, and Bootstrap Icons throughout. All chart styling is driven by CSS variables in `assets/style.css` and the shared `CHART_T` Plotly template in `data_loader.py`.

## Dataset

- **Source:** FDA FAERS Q4 2025 (October–December 2025), three XML safety report files
- **Reports:** ~385,000 Individual Case Safety Reports (ICSRs)
- **Drug records:** ~1.9 million (multiple drugs per report)
- **Reaction records:** ~1.3 million (MedDRA PT coded terms)
- **Serious rate:** ~56.7% | **Fatal rate:** ~6.8%
